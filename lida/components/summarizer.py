...
i) ALWAYS generate the name of the dataset and a non-empty dataset_description.
ii) ALWAYS generate a field description. Never leave description field empty.
